Ext.define('transparence.view.form.Dyn', {
	extend : 'Ext.Container',
	alias : 'widget.formdyn',
	requires : [, 'Ext.field.Radio', 'Ext.field.Spinner' ,'transparence.model.dynamicperson', 'Ext.field.DatePicker', 'Ext.field.FileInput',	'transparence.model.User' ],
	initialize : function() {
	...
	createUser : function(configuration, value) {
		...
		user = Ext.create('transparence.model.dynamicperson', value);
	...
	getAjaxItems : function() {
		var me = this;
		Ext.data.JsonP.request({
			url : 'http://transparence-medicale.fr/data/mobile/form',
			reader : {
				type : 'json',
				root : 'data'
			},
